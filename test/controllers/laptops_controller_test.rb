...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference("Laptop.count") do
      post laptops_url, params: { laptop: { brand: @laptop.brand, model: @laptop.model, price: @laptop.price } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { brand: @laptop.brand, model: @laptop.model, price: @laptop.price } }
